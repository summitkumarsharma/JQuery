$(document).ready(function() {
    ...
    // $('#ta').val('setting it to sumit');
    // $('#ta').html('setting it to sumit nn');
    // $('#ta').html('setting it to sumit3');
    // $('#inp').html('setting it to sumit3');
    // $('#inp').val('setting it to sumit3');
    // $('#inp').empty()
    // $('#wiki').empty()
    ...
    $('#wiki').css('background-color', 'blue')
